  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-400">Monitor and manage your Docker infrastructure</p>
      </div>
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-slate-300">Docker Daemon</span>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 bg-orange-500/10 border border-orange-500/20 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">Container: webapp-frontend</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">Database: postgres-main</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Recent Containers */}
      <div>
        <h2 className="text-xl font-semibold text-white mb-6">Recent Containers</h2>
